...
use crate::{
    http::controllers::middleware::ip_rate_limit::too_many_requests_response,
...
#[utoipa::path(
    ...
    responses(
        ...
        (status = 429, description = "Too many guest accounts created from this network", body = ApiResponse),
    ),
)]
